---
layout: post
title: Git 分支之分支创建与合并-3.2
date: 2019-1-17 09:34:35 +0800
categories: [Git]
tags: [git, devops, sh]
published: true
excerpt: Git 分支之分支创建与合并-3.2
---
...
![Figure 18. 一个简单提交历史](https://git-scm.com/book/en/v2/images/basic-branching-1.png)
...
![Figure 19. 创建一个新分支指针](https://git-scm.com/book/en/v2/images/basic-branching-2.png)
...
![Figure 20. iss53 分支随着工作的进展向前推进](https://git-scm.com/book/en/v2/images/basic-branching-3.png)
...
![Figure 21. 基于 master 分支的紧急问题分支 hotfix branch](https://git-scm.com/book/en/v2/images/basic-branching-4.png)
...
![Figure 22. master 被快进到 hotfix](https://git-scm.com/book/en/v2/images/basic-branching-5.png)
...
![Figure 23. 继续在 iss53 分支上的工作](https://git-scm.com/book/en/v2/images/basic-branching-6.png)
...
![Figure 24. 一次典型合并中所用到的三个快照](https://git-scm.com/book/en/v2/images/basic-merging-1.png)

和之前将分支指针向前推进所不同的是，Git 将此次三方合并的结果做了一个新的快照并且自动创建一个新的提交指向它。 这个被称作一次合并提交，它的特别之处在于他有不止一个父提交。

![Figure 25. 一个合并提交](https://git-scm.com/book/en/v2/images/basic-merging-2.png)
